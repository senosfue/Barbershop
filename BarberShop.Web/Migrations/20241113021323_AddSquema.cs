    ...
    public partial class AddSquema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarberShopRoles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarberShopRoleId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BarberShopRoles_BarberShopRoleId",
                        column: x => x.BarberShopRoleId,
                        principalTable: "BarberShopRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissions_BarberShopRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "BarberShopRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BarberShopRoleId",
                table: "AspNetUsers",
                column: "BarberShopRoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarberShopRoles_Name",
                table: "BarberShopRoles",
                column: "Name",
                unique: true);
